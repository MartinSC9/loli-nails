      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center size-8 rounded-sm bg-primary text-white">
              <span className="material-symbols-outlined text-xl">flare</span>
            </div>
            <h2 className="text-lg font-extrabold tracking-tight text-slate-900">Loli <span className="text-primary">Nails</span></h2>
          </div>
