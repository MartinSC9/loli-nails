    ...
    <header className={`sticky top-0 z-50 w-full glass-card border-b border-primary/10 ${scrolled ? 'shadow-lg' : ''}`}>
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-4">
          <a href="https://wa.me/5493513818087?text=Hola!%20Te%20hablo%20desde%20la%20p%C3%A1gina%20de%20Loli%20Nails%20Quiero%20reservar%20un%20turno" target="_blank" rel="noopener" className="hidden sm:flex px-6 h-11 rounded-full bg-primary text-white text-sm font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 items-center gap-2">
